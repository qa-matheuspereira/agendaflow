...
function buildSystemPrompt(cfg: WhatsappConfig | null | undefined, clientName?: string): string {
  ...
  const lines = [
    ...
    '  2. Pergunte: "Qual serviço você deseja?" — AGUARDE resposta',
    '  3. Só após escolher o serviço → busque datas disponíveis',
    '  4. Mostre datas → aguarde → mostre horários → aguarde → confirme',
    '  NUNCA chame book_appointment sem o cliente ter escolhido explicitamente um serviço nesta conversa.',
    '',
