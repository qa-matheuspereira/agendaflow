...
var isAuthenticated = function (waPage) {
    return waPage.evaluate(function () {
        try {
            if (WPP && WPP.conn && typeof WPP.conn.isRegistered === 'function') {
                return WPP.conn.isRegistered();
            }
        } catch(e) {}
        try {
            if (WPP && WPP.conn && typeof WPP.conn.isAuthenticated === 'function') {
